      ...
      <div className="event-card">
        <div className="event-details">
          ...
          <div className="event-meta">
            <span className="event-date">Friday, April 10, 2026</span>
            <span className="event-location">@ The Meadows</span>
          </div>
          <p className="event-description">
            Celebrate the end of the semester at The Meadows. 
          ...
          <div className="event-rsvp-info">
            ...
            <span className="rsvp-text">Alice, Bob, and 3 others are going</span>
          </div>
        </div>
